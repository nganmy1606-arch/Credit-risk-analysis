...
## Sample Visuals ![Correlation Heatmap](images/correlation_heatmap.png) 

Correlation heatmap of numerical attributes.

![Default Rate by Income Ratio](images/default_rate_by_income.png) 

Default rate rises sharply once a loan exceeds ~30% of income.

![Balanced Model](images/confusion_matrix_balanced.png) 

The balanced model catches 79% of actual defaulters.
